export const en = {
  ...
  "auth.register.subtitle": "Sign up to get access",
  "auth.error.name_required": "Please enter your name",
  "auth.success.registered": "Successfully registered! You can now login.",
  "auth.field.name": "Full Name",
  "auth.field.name.placeholder": "John Doe",
  "auth.field.email.placeholder": "you@example.com",
  "auth.field.password": "Password",
  "auth.field.password.placeholder": "Minimum 6 characters",
  "auth.btn.loading": "Loading...",
  "auth.btn.login": "Login",
  "auth.btn.register": "Register",
  "auth.btn.logout": "Logout",
  "auth.btn.header_login": "Login",
};
